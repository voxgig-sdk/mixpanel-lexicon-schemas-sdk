...
// MixpanelLexiconSchemas SDK pipeline test
//
...
{
    private static function utility(): MixpanelLexiconSchemasUtility
    {
        return new MixpanelLexiconSchemasUtility();
    }
    ...
    private static function ctx(array $over = []): MixpanelLexiconSchemasContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new MixpanelLexiconSchemasContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new MixpanelLexiconSchemasOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof MixpanelLexiconSchemasError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new MixpanelLexiconSchemasOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = MixpanelLexiconSchemasMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new MixpanelLexiconSchemasOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = MixpanelLexiconSchemasMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new MixpanelLexiconSchemasOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = MixpanelLexiconSchemasMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MixpanelLexiconSchemasSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = MixpanelLexiconSchemasMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new MixpanelLexiconSchemasResponse([]),
            'result' => new MixpanelLexiconSchemasResult([]),
        ]);
        [, $err] = MixpanelLexiconSchemasMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new MixpanelLexiconSchemasSpec([]),
            'response' => null,
            'result' => new MixpanelLexiconSchemasResult([]),
        ]);
        [, $err] = MixpanelLexiconSchemasMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new MixpanelLexiconSchemasSpec(['step' => 's']),
            'response' => new MixpanelLexiconSchemasResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new MixpanelLexiconSchemasResult([]),
        ]);
        [, $err] = MixpanelLexiconSchemasMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new MixpanelLexiconSchemasSpec(['step' => 's']),
            'response' => new MixpanelLexiconSchemasResponse(self::resp(200, ['v' => 1])),
            'result' => new MixpanelLexiconSchemasResult([]),
        ]);
        [, $err] = MixpanelLexiconSchemasMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new MixpanelLexiconSchemasSpec(['step' => 's']),
            'response' => new MixpanelLexiconSchemasResponse(self::resp(200, ['v' => 2])),
            'result' => new MixpanelLexiconSchemasResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        MixpanelLexiconSchemasMakeResponse::call($ctx);
    ...
    {
        $preset = new MixpanelLexiconSchemasResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new MixpanelLexiconSchemasSpec([]),
            'response' => new MixpanelLexiconSchemasResponse([]),
            'result' => new MixpanelLexiconSchemasResult([]),
        ...
        [$got, $err] = MixpanelLexiconSchemasMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new MixpanelLexiconSchemasResult([])]);
        [, $err] = MixpanelLexiconSchemasMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new MixpanelLexiconSchemasSpec([]), 'result' => null]);
        [, $err] = MixpanelLexiconSchemasMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MixpanelLexiconSchemasSpec(['step' => 's']),
            'result' => new MixpanelLexiconSchemasResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new MixpanelLexiconSchemasOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MixpanelLexiconSchemasMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new MixpanelLexiconSchemasSpec(['step' => 's']),
            'result' => new MixpanelLexiconSchemasResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new MixpanelLexiconSchemasOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = MixpanelLexiconSchemasMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new MixpanelLexiconSchemasResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new MixpanelLexiconSchemasSpec([]),
            'result' => new MixpanelLexiconSchemasResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = MixpanelLexiconSchemasMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MixpanelLexiconSchemasMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new MixpanelLexiconSchemasError('boom', 'boom');
        $utility->fetcher = function (MixpanelLexiconSchemasContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MixpanelLexiconSchemasSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = MixpanelLexiconSchemasMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (MixpanelLexiconSchemasContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = MixpanelLexiconSchemasMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(MixpanelLexiconSchemasResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        MixpanelLexiconSchemasMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (MixpanelLexiconSchemasContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new MixpanelLexiconSchemasSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = MixpanelLexiconSchemasMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new MixpanelLexiconSchemasResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new MixpanelLexiconSchemasSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = MixpanelLexiconSchemasMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = MixpanelLexiconSchemasMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = MixpanelLexiconSchemasMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new MixpanelLexiconSchemasResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, MixpanelLexiconSchemasDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new MixpanelLexiconSchemasResult(['ok' => false])]);
        $this->expectException(MixpanelLexiconSchemasError::class);
        MixpanelLexiconSchemasDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new MixpanelLexiconSchemasResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', MixpanelLexiconSchemasMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        MixpanelLexiconSchemasMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new MixpanelLexiconSchemasBaseFeature();
        $b = new MixpanelLexiconSchemasBaseFeature();
        MixpanelLexiconSchemasFeatureAdd::call($ctx, $a);
        MixpanelLexiconSchemasFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): MixpanelLexiconSchemasBaseFeature
    {
        $f = new MixpanelLexiconSchemasBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        MixpanelLexiconSchemasFeatureAdd::call($ctx, self::named_feature('a'));
        MixpanelLexiconSchemasFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        MixpanelLexiconSchemasFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        MixpanelLexiconSchemasFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        MixpanelLexiconSchemasFeatureAdd::call($ctx, $replace);
        ...
        MixpanelLexiconSchemasFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): MixpanelLexiconSchemasContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new MixpanelLexiconSchemasSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = MixpanelLexiconSchemasPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        MixpanelLexiconSchemasPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new MixpanelLexiconSchemasResponse(['headers' => null]),
            'result' => new MixpanelLexiconSchemasResult([]),
        ]);
        MixpanelLexiconSchemasResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        MixpanelLexiconSchemasResultBody::call($ctx);
