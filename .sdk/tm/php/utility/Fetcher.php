...
// MixpanelLexiconSchemas SDK utility: fetcher

class MixpanelLexiconSchemasFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; MixpanelLexiconSchemasSDK/1.0)';
    ...
    public static function call(MixpanelLexiconSchemasContext $ctx, string $fullurl, array $fetchdef): array
    {
