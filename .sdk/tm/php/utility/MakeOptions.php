...
// MixpanelLexiconSchemas SDK utility: make_options

class MixpanelLexiconSchemasMakeOptions
{
    ...
    public static function call(MixpanelLexiconSchemasContext $ctx): array
    {
        ...
        //
        // `MixpanelLexiconSchemasSchema::optspec()` is built from the model:
        ...
        $optspec = MixpanelLexiconSchemasSchema::optspec();
