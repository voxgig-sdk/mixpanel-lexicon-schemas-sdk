...
// MixpanelLexiconSchemas SDK utility: prepare_method

class MixpanelLexiconSchemasPrepareMethod
{
    ...
    public static function call(MixpanelLexiconSchemasContext $ctx): ?string
    {
