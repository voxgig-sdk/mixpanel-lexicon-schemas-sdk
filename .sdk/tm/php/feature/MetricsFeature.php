...
class MixpanelLexiconSchemasMetricsFeature extends MixpanelLexiconSchemasBaseFeature
{
    ...
    private function _record(MixpanelLexiconSchemasContext $ctx, bool $ok): void
    {
