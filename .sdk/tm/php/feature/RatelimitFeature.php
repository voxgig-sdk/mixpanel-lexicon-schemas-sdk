...
// MixpanelLexiconSchemas SDK ratelimit feature
...
class MixpanelLexiconSchemasRatelimitFeature extends MixpanelLexiconSchemasBaseFeature
{
    ...
    private function _acquire(MixpanelLexiconSchemasContext $ctx): void
    {
    ...
    private function _track(MixpanelLexiconSchemasContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
