...
class MixpanelLexiconSchemasIdempotencyFeature extends MixpanelLexiconSchemasBaseFeature
{
    ...
    private function _mutating(MixpanelLexiconSchemasContext $ctx): bool
    {
