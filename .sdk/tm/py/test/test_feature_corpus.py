# MixpanelLexiconSchemas SDK feature corpus test
#
...
def _client(kase):
    ...
    MixpanelLexiconSchemasSDK(...), not MixpanelLexiconSchemasSDK.test(...): the `test` feature is
    ...
    return MixpanelLexiconSchemasSDK(opts)
