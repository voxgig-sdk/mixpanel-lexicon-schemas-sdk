...
local function make_error_util(ctx, err)
  ...
  local msg = "MixpanelLexiconSchemasSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = MixpanelLexiconSchemasError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == MixpanelLexiconSchemasError then
