...
|---|---|---|
| `js/` | @voxgig-sdk/mixpanel-lexicon-schemas-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/mixpanel-lexicon-schemas | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/mixpanel-lexicon-schemas-js \
      --repository voxgig-sdk/mixpanel-lexicon-schemas-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/mixpanel-lexicon-schemas-js` shows it, and
`npm trust revoke @voxgig-sdk/mixpanel-lexicon-schemas-js --id=<id>` removes it.
