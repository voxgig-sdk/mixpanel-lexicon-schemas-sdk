...
local UploadSchemaEntity = {}
UploadSchemaEntity.__index = UploadSchemaEntity


function UploadSchemaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UploadSchemaEntity)
  self._name = "upload_schema"
  self._client = client
...
function UploadSchemaEntity:get_name()
  return self._name
end


function UploadSchemaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return UploadSchemaEntity.new(self._client, opts)
end
...
function UploadSchemaEntity:mark_deleted()
  self._deleted = true
end


function UploadSchemaEntity:deleted()
  return true == self._deleted
end


function UploadSchemaEntity:data_set(args)
  if args ~= nil then
...
function UploadSchemaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UploadSchemaEntity:match_set(args)
  if args ~= nil then
...
function UploadSchemaEntity:match_get()
...
function UploadSchemaEntity:stream(action, args, callopts)
...
---@param reqdata UploadSchemaCreateData
---@param ctrl? table
---@return UploadSchema
---@return string? err
function UploadSchemaEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function UploadSchemaEntity:_run_op(ctx, post_done)
  local utility = self._utility
