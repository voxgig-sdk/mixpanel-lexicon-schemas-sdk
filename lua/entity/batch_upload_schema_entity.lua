...
local BatchUploadSchemaEntity = {}
BatchUploadSchemaEntity.__index = BatchUploadSchemaEntity


function BatchUploadSchemaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BatchUploadSchemaEntity)
  self._name = "batch_upload_schema"
  self._client = client
...
function BatchUploadSchemaEntity:get_name()
  return self._name
end


function BatchUploadSchemaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BatchUploadSchemaEntity.new(self._client, opts)
end
...
function BatchUploadSchemaEntity:mark_deleted()
  self._deleted = true
end


function BatchUploadSchemaEntity:deleted()
  return true == self._deleted
end


function BatchUploadSchemaEntity:data_set(args)
  if args ~= nil then
...
function BatchUploadSchemaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BatchUploadSchemaEntity:match_set(args)
  if args ~= nil then
...
function BatchUploadSchemaEntity:match_get()
...
function BatchUploadSchemaEntity:stream(action, args, callopts)
...
---@param reqdata BatchUploadSchemaCreateData
---@param ctrl? table
---@return BatchUploadSchema
---@return string? err
function BatchUploadSchemaEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function BatchUploadSchemaEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return BatchUploadSchemaEntity
