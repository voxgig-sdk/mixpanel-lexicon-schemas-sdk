...
local SDK_MODULE = "mixpanel-lexicon-schemas_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["batch_upload_schema"] = { ["test01"] = { id = "test01" } }, ["project"] = { ["test01"] = { id = "test01" } }, ["schema"] = { ["test01"] = { id = "test01" } }, ["upload_schema"] = { ["test01"] = { id = "test01" } } } }'
