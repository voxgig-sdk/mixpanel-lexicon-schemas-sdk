# MixpanelLexiconSchemas JavaScript SDK



The JavaScript SDK for the MixpanelLexiconSchemas API — an entity-oriented client with full async/await support.
...
## Install
```js
npm install mixpanel-lexicon-schemas
```
...
```js
const client = new MixpanelLexiconSchemasSDK({ apikey: '...' })
...
| `results` | `Array` |  |
| `schemaJson` | `Object` | The schema for the entity |
| `status` | `string` |  |
...
├── src/
│   ├── MixpanelLexiconSchemasSDK.js        # Main SDK class
