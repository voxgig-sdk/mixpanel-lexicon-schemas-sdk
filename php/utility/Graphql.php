...
// MixpanelLexiconSchemas SDK utility: graphql
//
...
class MixpanelLexiconSchemasGraphql
{
    ...
    // equivalent.
    public static function body(MixpanelLexiconSchemasContext $ctx): mixed
    {
    ...
    public static function errors(MixpanelLexiconSchemasContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
