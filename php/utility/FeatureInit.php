...
// MixpanelLexiconSchemas SDK utility: feature_init

class MixpanelLexiconSchemasFeatureInit
{
    public static function call(MixpanelLexiconSchemasContext $ctx, mixed $f): void
    {
        $fname = $f->get_name();
        $fopts = [];
        if ($ctx->options) {
