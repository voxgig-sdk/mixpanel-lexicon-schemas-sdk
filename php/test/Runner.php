...
class MixpanelLexiconSchemasTestRunner
{
    ...
    {
        $live = self::getenv('MIXPANEL_LEXICON_SCHEMAS_TEST_LIVE');
        $override = self::getenv('MIXPANEL_LEXICON_SCHEMAS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('MIXPANEL_LEXICON_SCHEMAS_TEST_EXPLAIN');
...
class_alias('MixpanelLexiconSchemasTestRunner', 'Runner');
class_alias('MixpanelLexiconSchemasHelpers', 'Helpers');
