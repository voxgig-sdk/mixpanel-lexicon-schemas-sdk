...
// MixpanelLexiconSchemas SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = MixpanelLexiconSchemasOmni::makeStructRunner(
    ...
    {
        return MixpanelLexiconSchemasOmni::objmodel(MixpanelLexiconSchemasOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return MixpanelLexiconSchemasOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return MixpanelLexiconSchemasOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(MixpanelLexiconSchemasOmni::structfix($now, Struct::undef()))
                        !== json_encode(MixpanelLexiconSchemasOmni::structfix($val, Struct::undef()))) {
