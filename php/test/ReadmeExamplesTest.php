...
// MixpanelLexiconSchemas SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (MixpanelLexiconSchemasSDK::test)
...
{
    private const SDK_CLASS = 'MixpanelLexiconSchemasSDK';
    ...
    private const SDK_BASE = 'mixpanellexiconschemas_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../mixpanellexiconschemas_sdk.php';
