...
// MixpanelLexiconSchemas SDK utility type

class MixpanelLexiconSchemasUtility
{
    ...
    public static function copy(MixpanelLexiconSchemasUtility $src): MixpanelLexiconSchemasUtility
    {
        $u = new MixpanelLexiconSchemasUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
