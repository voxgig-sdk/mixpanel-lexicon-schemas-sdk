...
// MixpanelLexiconSchemas SDK paging feature
...
class MixpanelLexiconSchemasPagingFeature extends MixpanelLexiconSchemasBaseFeature
{
    ...
    private function _graphql_pre_request(MixpanelLexiconSchemasContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(MixpanelLexiconSchemasContext $ctx): bool
    {
