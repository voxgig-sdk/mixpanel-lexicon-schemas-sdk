...
// MixpanelLexiconSchemas SDK timeout feature
...
class MixpanelLexiconSchemasTimeoutFeature extends MixpanelLexiconSchemasBaseFeature
{
    ...
    private function _with_timeout(MixpanelLexiconSchemasContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(MixpanelLexiconSchemasContext $_ctx, float $ms): void
    {
        $client = $this->client;
