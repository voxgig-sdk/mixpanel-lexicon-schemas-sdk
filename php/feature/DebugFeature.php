...
class MixpanelLexiconSchemasDebugFeature extends MixpanelLexiconSchemasBaseFeature
{
    ...
    private function _finish(MixpanelLexiconSchemasContext $ctx, bool $ok): void
    {
