...
// MixpanelLexiconSchemas SDK UploadSchema entity
...
class UploadSchemaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UploadSchemaEntity($this->_client, $opts);
    }

    /**
     * @param UploadSchema|array $args UploadSchema data (assoc-array) to store.
     */
    ...
    /**
     * @return UploadSchema|array The current UploadSchema data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UploadSchema fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UploadSchema fields).
     */
    ...
    /**
     * Create a new UploadSchema.
     *
     * @param UploadSchemaCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UploadSchemaCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UploadSchema|array The created UploadSchema as an assoc-array at the
