...
// MixpanelLexiconSchemas SDK Schema entity
...
class SchemaEntity
{
    ...
    /**
     * List Schema items matching the given filter.
     *
     * @param SchemaListMatch|array|null $reqmatch Match filter (any subset
     *   of Schema fields) as an assoc-array; SchemaListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Schema[]|array A list of Schema items as assoc-arrays at
     *   the SDK boundary; throws MixpanelLexiconSchemasError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Schema matching the given criteria.
     *
     * @param SchemaRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; SchemaRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Schema|array The removed Schema as an assoc-array at the
     *   SDK boundary; throws MixpanelLexiconSchemasError on failure (item-5 convention).
     */
