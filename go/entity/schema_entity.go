...
func NewSchemaEntity(client *core.MixpanelLexiconSchemasSDK, entopts map[string]any) *SchemaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SchemaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// SchemaListMatch and returns []Schema. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *SchemaEntity) ListTyped(reqmatch SchemaListMatch, ctrl map[string]any) ([]Schema, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Schema](res), nil
}
...
func (e *SchemaEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// SchemaRemoveMatch and returns an Schema. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *SchemaEntity) RemoveTyped(reqmatch SchemaRemoveMatch, ctrl map[string]any) (Schema, error) {
