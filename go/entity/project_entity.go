...
func NewProjectEntity(client *core.MixpanelLexiconSchemasSDK, entopts map[string]any) *ProjectEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProjectEntity) DataTyped(data ...Project) Project {
	...
	return typedFrom[Project](e.Data())
}
...
func (e *ProjectEntity) MatchTyped(match ...Project) Project {
	...
	return typedFrom[Project](e.Match())
}
...
func (e *ProjectEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ProjectEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ProjectEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ProjectEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
