...
type UploadSchemaEntity struct {
	name    string
...
func NewUploadSchemaEntity(client *core.MixpanelLexiconSchemasSDK, entopts map[string]any) *UploadSchemaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UploadSchemaEntity) GetName() string { return e.name }
...
func (e *UploadSchemaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UploadSchemaEntity) Deleted() bool {
	return e.deleted
}


func (e *UploadSchemaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUploadSchemaEntity(e.client, opts)
}

func (e *UploadSchemaEntity) Data(args ...any) any {
...
func (e *UploadSchemaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an UploadSchema; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UploadSchemaEntity) DataTyped(data ...UploadSchema) UploadSchema {
	if len(data) > 0 {
		return typedFrom[UploadSchema](e.Data(asMap(data[0])))
	}
	return typedFrom[UploadSchema](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through UploadSchema (all fields
// optional at the wire level).
func (e *UploadSchemaEntity) MatchTyped(match ...UploadSchema) UploadSchema {
	if len(match) > 0 {
		return typedFrom[UploadSchema](e.Match(asMap(match[0])))
	}
	return typedFrom[UploadSchema](e.Match())
}
...
func (e *UploadSchemaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UploadSchemaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *UploadSchemaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *UploadSchemaEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UploadSchemaCreateData and returns an UploadSchema. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *UploadSchemaEntity) CreateTyped(reqdata UploadSchemaCreateData, ctrl map[string]any) (UploadSchema, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return UploadSchema{}, err
	}
	return typedFrom[UploadSchema](res), nil
}



func (e *UploadSchemaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UploadSchemaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UploadSchemaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
