package voxgigmixpanellexiconschemassdk

import (
	"github.com/voxgig-sdk/mixpanel-lexicon-schemas-sdk/go/core"
	"github.com/voxgig-sdk/mixpanel-lexicon-schemas-sdk/go/entity"
	"github.com/voxgig-sdk/mixpanel-lexicon-schemas-sdk/go/feature"
	_ "github.com/voxgig-sdk/mixpanel-lexicon-schemas-sdk/go/utility"
)

// Type aliases preserve external API.
type MixpanelLexiconSchemasSDK = core.MixpanelLexiconSchemasSDK
type Context = core.Context
type Utility = core.Utility
type Feature = core.Feature
type Entity = core.Entity
type MixpanelLexiconSchemasEntity = core.MixpanelLexiconSchemasEntity
...
type MixpanelLexiconSchemasError = core.MixpanelLexiconSchemasError
...
func init() {
	...
	core.NewUploadSchemaEntityFunc = func(client *core.MixpanelLexiconSchemasSDK, entopts map[string]any) core.MixpanelLexiconSchemasEntity {
		return entity.NewUploadSchemaEntity(client, entopts)
	}
}

// Constructor re-exports.
var NewMixpanelLexiconSchemasSDK = core.NewMixpanelLexiconSchemasSDK
...
// instead of `sdk.NewMixpanelLexiconSchemasSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *MixpanelLexiconSchemasSDK  { return NewMixpanelLexiconSchemasSDK(nil) }
func Test() *MixpanelLexiconSchemasSDK { return TestSDK(nil, nil) }
