...
import "github.com/voxgig-sdk/mixpanel-lexicon-schemas-sdk/go/core"
...
func makeErrorUtil(ctx *core.Context, err error) (any, error) {
	...
	sdkErr := &core.MixpanelLexiconSchemasError{
	...
	if se, ok := err.(*core.MixpanelLexiconSchemasError); ok {
		sdkErr.Code = se.Code
	}
