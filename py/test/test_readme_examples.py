# MixpanelLexiconSchemas SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions MixpanelLexiconSchemasSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both MixpanelLexiconSchemasSDK(...) and MixpanelLexiconSchemasSDK.test(...) become
#      MixpanelLexiconSchemasSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "mixpanellexiconschemas_sdk"
_SDK_CLASS = "MixpanelLexiconSchemasSDK"
