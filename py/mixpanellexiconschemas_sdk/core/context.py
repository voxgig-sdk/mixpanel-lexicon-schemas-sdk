...
from mixpanellexiconschemas_sdk.core.control import MixpanelLexiconSchemasControl
...
from mixpanellexiconschemas_sdk.core.helpers import get_ctx_prop, to_map
...
class MixpanelLexiconSchemasContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = MixpanelLexiconSchemasControl()
        ...
        if isinstance(sp, MixpanelLexiconSchemasSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, MixpanelLexiconSchemasResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, MixpanelLexiconSchemasResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return MixpanelLexiconSchemasOperation({})
        ...
        op = MixpanelLexiconSchemasOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return MixpanelLexiconSchemasError(code, msg, self)
