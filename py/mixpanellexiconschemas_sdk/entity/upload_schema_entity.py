...
class UploadSchemaEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return UploadSchemaEntity(self._client, opts)
    ...
    def data_get(self) -> UploadSchema:
    ...
    def match_get(self) -> UploadSchema:
    ...
    def create(self, reqdata: UploadSchemaCreateData, ctrl=None) -> UploadSchema:
        utility = self._utility
