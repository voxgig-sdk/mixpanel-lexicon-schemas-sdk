...
from mixpanellexiconschemas_sdk.mixpanellexiconschemas_types import (
    BatchUploadSchema,
...
class BatchUploadSchemaEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return BatchUploadSchemaEntity(self._client, opts)
    ...
    def data_get(self) -> BatchUploadSchema:
    ...
    def match_get(self) -> BatchUploadSchema:
    ...
    def create(self, reqdata: BatchUploadSchemaCreateData, ctrl=None) -> BatchUploadSchema:
        utility = self._utility
