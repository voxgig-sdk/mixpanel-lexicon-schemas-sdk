...
from mixpanellexiconschemas_sdk.utility import register

# Load features
from mixpanellexiconschemas_sdk.feature.base_feature import MixpanelLexiconSchemasBaseFeature
from mixpanellexiconschemas_sdk.features import _has_feature, _make_feature
...
class MixpanelLexiconSchemasSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = MixpanelLexiconSchemasUtility()
        self._utility = utility

        from mixpanellexiconschemas_sdk.config import shared_config
    ...
    def get_utility(self):
        return MixpanelLexiconSchemasUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("MixpanelLexiconSchemasSDK: graphql: " + str(msg))
            res["graphql"] = errors

        return res


    def BatchUploadSchema(self, data=None) -> "BatchUploadSchemaEntity":
        """Entity factory: client.BatchUploadSchema().list() / client.BatchUploadSchema().load({"id": ...})."""
    ...
    def UploadSchema(self, data=None) -> "UploadSchemaEntity":
        """Entity factory: client.UploadSchema().list() / client.UploadSchema().load({"id": ...})."""
        from mixpanellexiconschemas_sdk.entity.upload_schema_entity import UploadSchemaEntity
        return UploadSchemaEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "MixpanelLexiconSchemasSDK":
        if sdkopts is None:
            sdkopts = {}
