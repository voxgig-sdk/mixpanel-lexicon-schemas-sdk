// Command MixpanelLexiconSchemas-cli is a CLI + REPL for the MixpanelLexiconSchemas SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      MIXPANEL_LEXICON_SCHEMAS_APIKEY (api key), MIXPANEL_LEXICON_SCHEMAS_BASE (base url override)")
