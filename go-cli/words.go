...
func registerSDKWords(r *eng.Registry, client *sdk.MixpanelLexiconSchemasSDK) {
...
func runOp(client *sdk.MixpanelLexiconSchemasSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
