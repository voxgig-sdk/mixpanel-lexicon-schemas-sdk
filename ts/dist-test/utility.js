...
function envOverride(m) {
    if ('TRUE' === process.env.MIXPANEL_LEXICON_SCHEMAS_TEST_LIVE ||
        'TRUE' === process.env.MIXPANEL_LEXICON_SCHEMAS_TEST_OVERRIDE) {
    ...
    m.MIXPANEL_LEXICON_SCHEMAS_TEST_EXPLAIN = process.env.MIXPANEL_LEXICON_SCHEMAS_TEST_EXPLAIN || m.MIXPANEL_LEXICON_SCHEMAS_TEST_EXPLAIN;
    return m;
}
