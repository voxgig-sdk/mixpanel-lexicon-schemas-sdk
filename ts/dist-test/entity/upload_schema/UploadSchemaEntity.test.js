...
function basicSetup(extra) {
    ...
    let idmap = transform(['upload_schema01', 'upload_schema02', 'upload_schema03', 'project01', 'project02', 'project03', 'schema01', 'schema02', 'schema03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
