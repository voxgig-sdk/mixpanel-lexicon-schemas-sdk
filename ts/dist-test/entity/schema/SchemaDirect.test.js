...
(0, node_test_1.describe)('SchemaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.MixpanelLexiconSchemasSDK({
    ...
    (0, node_test_1.test)('direct-load-schema', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-schema', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["project01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-schema', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-schema', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["project01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.MixpanelLexiconSchemasSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
    ...
    const client = new __1.MixpanelLexiconSchemasSDK({
        base: 'http://localhost:8080',
