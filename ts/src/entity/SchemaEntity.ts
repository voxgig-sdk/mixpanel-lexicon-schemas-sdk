...
class SchemaEntity extends MixpanelLexiconSchemasEntityBase<Schema> {
  ...
  async list(this: any, reqmatch?: SchemaListMatch, ctrl?: Control): Promise<SchemaEntity[]> {
  ...
  async remove(
    this: any, reqmatch?: SchemaRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<SchemaEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
