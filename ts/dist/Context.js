...
const MixpanelLexiconSchemasError_1 = require("./MixpanelLexiconSchemasError");
...
class Context {
    ...
    error(code, msg) {
        return new MixpanelLexiconSchemasError_1.MixpanelLexiconSchemasError(code, msg, this);
    }
    toJSON() {
        return {
            id: this.id,
